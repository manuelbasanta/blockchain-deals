...
const LearnMore = () => {
    return (
        <div className="bg-[url('/imgs//main-background.svg')] bg-cover">
            <div className="backdrop-blur bg-white/90">
                <div className="flex flex-col md:flex-row items-center justify-between w-full gap-8 md:gap-36 text-lg pt-[100px] mb-20 md:mb-16" id="learn-more">
                    <div>
                        <p className="text-4xl md:text-6xl font-bold">What's a Blockchain Escrow Deal?</p>
                    </div>
                    <div className="text-sm bg-white p-8 rounded border border-gray-900">
                ...
                <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full gap-8 md:gap-36 text-lg">
                    ...
                    <div>
                        <p className="text-4xl md:text-6xl font-bold text-left md:text-right">Why should I use <span className={pt_serif.className}>Blockchain Deals</span>?</p>
                    </div>
                </div>
                <div className="flex flex-col md:flex-row items-center justify-between w-full gap-8 md:gap-36 text-lg mt-16 md:pt-[100px] mb-14 md:mb-40">
                    <div>
                        <p className="text-4xl md:text-6xl font-bold">So, how does the Deal work?</p>
                    </div>
                    <div className="bg-white p-8 rounded border border-gray-900">
                        <NumberedList
                            items={[
