...
const LearnMore = () => {
    return (
        <>
            <div className={`flex flex-col md:flex-row items-center justify-between w-full gap-8 md:gap-36 text-lg pt-[100px] mb-20 md:mb-48`} id="learn-more">
                <div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full gap-8 md:gap-36 text-lg pt-16 md:pt-[100px]  mb-14 md:mb-40">
                <div>
