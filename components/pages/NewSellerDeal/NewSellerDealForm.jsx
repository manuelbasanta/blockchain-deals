...
const NewSellerDealForm = () => {
    ...
    return (
        <div className="flex flex-col gap-6 relative">
            ...
            <Input label="Your deposit" data={creatorDepositData} validationText="Your deposit has to be grater than 0." handleChange={handleCreatorDepositChange} placeholder={`Your deposit in ${CHAIN_DATA[selectedChain].nativeCurrency}`} type="number" info="We recommend to set a deposit that is at least 110% of the value (i.e. if the value is .15 the deposit should be .165). This way the buyer can rest asured you will keep your part of the deal." />
