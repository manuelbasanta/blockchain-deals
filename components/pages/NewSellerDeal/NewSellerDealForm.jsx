...
const NewSellerDealForm = () => {
    ...
    return (
        <div className="flex flex-col gap-6 relative">
            ...
            <Input label="Buyer's deposit" data={buyerDepositData} validationText="The value should be grater than 0" handleChange={handleBuyerDepositChange} placeholder={`The buyer's deposit in ${CHAIN_DATA[selectedChain].nativeCurrency}`} type="number" info="You should agree what your deposit will be with the buyer." />
